...
//         match expr {
//             Expression::ArraySubscript(_, arr, idx) => unimplemented!(),
...
//             Data::Basic(basic) => {
//                 let ty = match basic {
//                     Data::Bool(_) => BasicType::Bool(),
//                     Data::Int(Int{ size, value: _}) => BasicType::Int((*size as u16) * 8),
//                     Data::Uint(Uint{ size, value: _}) => BasicType::Uint((*size as u16) * 8),
//                     Data::Bytes(Bytes{ size, value: _}) => BasicType::Bytes(size.clone()),
//                     Data::Address(Address{ payable, value: _}) => BasicType::Address(*payable),
//                     Data::StringQ(_) => BasicType::String(),
//                 };
